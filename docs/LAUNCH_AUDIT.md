...
- Paid research vendors (BatchData + RentCast) are configured in production — re-check `/api/credits` `vendors` flags or run a Pro skip-trace/AVM if lookups fail; see `docs/ENABLE_PAID_RESEARCH_APIS.md`
